...
<body style="background-image:url('images/update.png');">
...
<input type="submit" name="update" value="Update" style="color:black; background-color: aqua; height:30px; width:100px; border:10px black; font-size:15px; border-radius:10px">              
</div>  </form></div>
 <?php
if(isset($_POST['update'])) {
if(mysqli_query($con,"UPDATE `admin` set password='$_POST[password]' where full_name='$_POST[full_name]' AND email='$_POST[email]';"))
{ ?>
