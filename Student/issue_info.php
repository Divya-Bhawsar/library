...
<div class= container>
  <br><h1 style ="text-align:center; margin-top:10px; font-size:25px; font-family:cursive; font-weight:600; color:white;">Information Of Borrowed Books</h1><br><br><br>
  <?php
   if(isset($_SESSION['login_user']))
   {
    ...
    WHERE issue_book.approve='yes' and student_registration.full_name='$_SESSION[login_user]' ORDER BY `issue_book` . `returns` ASC  ";
