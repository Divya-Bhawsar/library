...
<div class="comment">
   ...
   // 
    ...
    while ($row = mysqli_fetch_assoc($res)) {
       //$res1=mysqli_query($con,"SELECT `image` from  `student_registration`;");
       // $userImage = $res1['image'];
        ...
        echo "<img class='img-circle profile-img' height=50  width=50 src='images/p.jpg'>";
        echo "<b style='font-size:20px;'>".$row['full-name']."</b> - <small>".time_elapsed_string($row['timer'])."</small>";
        echo "<button class='like-btn' data-id='" . $row['id'] . "' style='background:" . ($liked ? "#4CAF50" : "none") . "; border: none;margin-left:80px;'>
    ...
    <span class='glyphicon glyphicon-thumbs-down'></span> <span class='dislike-count'>" . $row['dislike_count'] . "</span>
        ...
        echo "<h4 style='margin-left:60px;'>".$row['com']."</h4><br>";
        ...
        echo "<form method='post' style='margin-top:10px'>
                ...
                <input type='text' name='reply' placeholder='Reply...' style='width:70%; border:1px solid black; border-radius:5px; height:40px;'  />
        ...
        while ($rep = mysqli_fetch_assoc($reps)) {
            echo "<br><div class='reply'><b>".$rep['full-name']."</b> - <small>".time_elapsed_string($rep['timer'])."</small><br>";
            echo $rep['com']."</div>";
        }
