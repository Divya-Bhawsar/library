...
<?php
            if(isset($_SESSION['login_user']))
            {
              $q=mysqli_query($con,"SELECT * FROM `issue_book` where full_name = '$_SESSION[login_user]' and approve=' ';");
              if(mysqli_num_rows($q)==0)
{
  echo "<h3 style='text-align:center; color:red; background:white; margin-top:150px;'>There is No Request...........</h3>";
  }
else{
  echo "<br><br><br>";
